            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
              ...
              <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-center flex-grow-1 pe-3 nav nav-underline">
                  ...
                  <li class="nav-item">
                    <a class="nav-link mx-lg-2" href="<?= base_url("panel_admin")?>">Panel Principal</a>
                  </li>
                   <li class="nav-item">
                    <a class="nav-link mx-lg-2" href="<?= base_url("catalogo")?>">Catálogo</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link mx-lg-2" href="<?= base_url("categorias")?>">Categorías</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link mx-lg-2" href="<?= base_url("usuarios")?>">Usuarios</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link mx-lg-2" href="<?= base_url("ventas")?>">Ventas</a>
                  </li>
                </ul>
              </div>
            </div>
